...
public class AdminRechercheDoctor {

    private RendezVousService rendezVousService;

    public AdminRechercheDoctor() {
    ...
    private void openRendezVous(int selectedDoctorId) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/vitalize/AdminRendezVous.fxml"));
            Parent root = loader.load();

            // Pass the selected doctor ID to the AdminRendezVous controller
            AdminRendezVous rendezVousController = loader.getController();
